...
import { X, MoreVertical, PlusSquare, Bell } from "lucide-react";

interface AndroidPushModalProps {
  onClose: () => void;
}

export default function AndroidPushModal({ onClose }: AndroidPushModalProps) {
  return (
      ...
      <div className="bg-white dark:bg-slate-900 w-full max-w-sm rounded-[2.5rem] p-6 shadow-2xl relative animate-in slide-in-from-bottom-8 duration-500">
        ...
        <div className="text-center pt-2">
          ...
          <p className="text-sm text-slate-500 dark:text-slate-400 mb-8 px-4">
            To receive updates on your Android device, you need to install this app to your home screen.
          </p>
          ...
          <div className="space-y-6 text-left bg-slate-50 dark:bg-slate-800/50 rounded-3xl p-6 border border-slate-100 dark:border-slate-800/50">
            <div className="flex items-start gap-4">
              ...
              <p className="text-sm text-slate-700 dark:text-slate-300">
                Tap the <span className="inline-flex items-center justify-center p-1 bg-white dark:bg-slate-700 rounded-md border border-slate-200 dark:border-slate-600 shadow-sm mx-1"><MoreVertical size={14} className="text-slate-600 dark:text-slate-400" /></span> <strong className="text-slate-900 dark:text-white">Menu</strong> button (three dots) in your browser.
              </p>
            </div>
            ...
            <div className="flex items-start gap-4">
              ...
              <p className="text-sm text-slate-700 dark:text-slate-300">
                Select <strong className="text-slate-900 dark:text-white">"Install app"</strong> or <span className="inline-flex items-center justify-center p-1 bg-white dark:bg-slate-700 rounded-md border border-slate-200 dark:border-slate-600 shadow-sm mx-1"><PlusSquare size={14} /></span> <strong className="text-slate-900 dark:text-white">"Add to Home screen"</strong>.
              </p>
            </div>
            ...
            <div className="flex items-start gap-4">
              ...
              <p className="text-sm text-slate-700 dark:text-slate-300">
                Open Project Makmur from your <strong className="text-slate-900 dark:text-white">Home Screen</strong> and go back to your profile to enable notifications.
              </p>
            </div>
          </div>
