...
export default function TimedCountdownScene({
  ...
  return (
    <div className="relative h-full w-full overflow-hidden rounded-2xl border border-white/10 bg-[#060d14]">
      ...
      {/* Content */}
      <div className="relative z-10 flex h-full items-center justify-between gap-6 px-10 py-8 text-white lg:px-16">
        {/* Left: status badge + prayer name + MM:SS timer */}
        ...
        {/* Right: Arabic prayer name */}
        {arabicName && (
          <div className="flex flex-shrink-0 items-center">
            <p
              className="font-bold leading-none text-white/70"
              style={{
