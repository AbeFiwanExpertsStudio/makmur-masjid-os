...
-- ===========================================================
-- 12. RESTORE CAPACITY ON CANCEL (TRIGGER)
-- ===========================================================
...
AS $$
BEGIN
  -- Only restore capacity if the kupon wasn't already scanned
...
-- ===========================================================
-- 13. PREVENT OVERBOOKING VOLUNTEER GIGS (TRIGGER)
-- ===========================================================
