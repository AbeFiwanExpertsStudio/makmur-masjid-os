...
messaging.onBackgroundMessage((payload) => {
  ...
  // NOTE: FCM automatically displays notifications when the message
  // includes a `notification` payload. Do NOT call showNotification()
  // here or the user will see duplicates.
});
